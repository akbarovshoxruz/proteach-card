...
function Hero() {
  return (
    <div className='hero w-full max-w-[1200px] m-auto text-center mt-[50px]'>
        ...
        <button className='button-hero' href="#">Natijalarni ko‘rish <PiArrowDownRightBold className='hero-icon'/></button>
    </div>
  )
}
